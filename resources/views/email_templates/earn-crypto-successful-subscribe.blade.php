                ...
                <td align="center" valign="top">
                  <table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0"
                    ...
                    <tbody>
                      ...
                      style="font-family: 'Montserrat', sans-serif; font-size:16px; color:#000; line-height:20px; font-weight: 300;">
                        <td>
                         Your new joining EARN CRYPTO trading package for<strong>  $<?php echo number_format($package_amount_usd,2); ?> USD / <?php echo number_format($package_amount_crypto, 8); ?> <?php echo $package_crypto_type; ?></strong> was successful.
                        </td>
                      </tr>
                      <tr>
                        <td height="30">&nbsp;</td>
