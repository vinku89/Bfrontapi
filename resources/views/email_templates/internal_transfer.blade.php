                ...
                <td align="center" valign="top">
                  <table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0"
                    ...
                    <tbody>
                      ...
                      style="font-family: 'Montserrat', sans-serif; font-size:16px; color:#000; line-height:20px; font-weight: 300;">
                        <td>
                        Your <strong>Transfer <?php echo $useremail['crypto_type']; ?></strong> of <strong><?php echo $useremail['crypto_amount']; ?> <?php echo $useremail['crypto_type']; ?></strong> to <strong><?php echo $useremail['receiver_username'];?></strong> via BREXILY account is successfuly transferred.
                        </strong>
                      </tr>
                      <tr>
                        <td height="15"></td>
                      ...
                      <tr>
                        <td height="150" style="text-align: center; display: none">
                          
                          <a href="<?php echo url('/');?>/confirm_withdraw_transaction/<?php echo $useremail['dtId'];?>" style="display: inline-block; width: 43%; float: right; margin: 0 auto; cursor: pointer; background-color: #21D228; padding: 15px; border: none; border-radius: 5px; font-family: 'Montserrat', sans-serif; font-size:18px; color:#fff; line-height:20px; font-weight: 600; ">VIEW TRANSFER DETAILS </a>
                        </td>
                      </tr>
