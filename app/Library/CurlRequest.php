...
class CurlRequest{
    ...
    private function __construct($baseUri, array $defaultHeaders = [], $timeout = 60)
    {
        ...
        $this->client = new Client([ 'base_uri' => $baseUri, 'timeout' => 60, 'exceptions' => false ]);
    }
    ...
    public function makeRequest(
        ...
        $response = $this->client->request($method, "{$endpoint}", [ 'form_params' => $formData, 'query' => $queryData, 'headers' => $headers,'debug' => false ]);
        return $response;
